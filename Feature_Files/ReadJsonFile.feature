...
* print "EndDate:"+ endDate
    ...
    * def data = read('classpath:JsonFile.json')
* def sleep =
      """
      function(seconds){
        for(i = 0; i <= seconds; i++)
...
Scenario Outline: Publish OrderPickedUp to deep
    ...
    * print req
      ...
      * def Expected_sms = "Your T-Mobile order# 6109698182 has shipped! Visit t-mo.co/shipment to check status of your order. Visit t-mo.co/guide for tips to set-up your new device."
